	...
	<div class="min-h-full">
	        ...
	        <div class="flex items-center">
	          ...
	          <div class="hidden md:block">
	            <div class="ml-10 flex items-baseline space-x-4">
	              ...
	              <a href="/team" class="bg-gray-900 text-white text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>
	  ...
	  <main>
	    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
	      <p>Hello, world. You are on Team page</p>
	    </div>
	  </main>
	</div>
</body>
